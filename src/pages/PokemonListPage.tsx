...
export default function PokemonListPage({ data }: { data: any[] }) {
  ...
  return (
    <section className="relative font-poppins">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 px-10 py-[32.6px] relative z-10">
      ...
      <div className="flex justify-center items-center mt-[37px] z-10 relative">
